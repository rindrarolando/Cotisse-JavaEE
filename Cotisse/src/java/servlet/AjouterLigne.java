 ...
 */
@WebServlet(name = "AjouterLigne", urlPatterns = {"/AjouterLigne"})
public class AjouterLigne extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String desc = depart+"-"+destination;
        String messageConfirmation = null;
        AdministratorService service = new AdministratorService();
        
        try{
            if(desc != null){
                service.ajouterDestination(desc);
                messageConfirmation = "Insertion réussite.";
            ...
            messageConfirmation = "Une erreur s'est produite.";
            request.setAttribute("message", messageConfirmation);

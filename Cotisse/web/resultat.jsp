...
<%
    ...
    RechercheService srv = new RechercheService();
    ArrayList<Destination> array = srv.recherche(search);
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Résultats de vos recherches.</h2>
                                                            ...
                                                            <tbody>
                                                                <% 
                                                                    for (int i=0 ; i<array.size();i++){ %>
                                                                        <tr>
                                                                            <td class="product-remove"><a href="reserver.jsp?id=<%=array.get(i).getIdDestination()%>">reserver</a></td>
                                                                            <td class="product-name"><%= array.get(i).getDescription() %></a></td>

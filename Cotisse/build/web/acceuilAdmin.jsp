                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="htc__login__register__wrap">
                            <div id="login" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                                <form class="login" method="get" action="AjouterLigne">
                                    
                                    <input type="text" name="depart" placeholder="Ville de départ...">
                                    <input type="text" name="destination" placeholder="Ville de destination...">
                                   
                                  <div class="htc__login__btn mt--30">
                                      <input type="submit" value="Ajouter la ligne.">
                                  </div>

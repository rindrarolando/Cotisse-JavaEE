                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <ul class="login__register__menu" role="tablist">
                            <li role="presentation" class="login active"><a href="#login" role="tab" data-toggle="tab">CONNEXION</a></li>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="htc__login__register__wrap">
                                ...
                                <form class="login" method="post" action="Connexion">
                                  ...
                                  <div class="htc__login__btn mt--30">
                                    ...
                                    <div class="row" style="padding-top: 50px;">
                                        <center><a href="loginAdmin.jsp">Connexion admin</a>
                                    </div>
                                </form>
                            ...
                            <div id="register" role="tabpanel" class="single__tabs__panel tab-pane fade">
                                <form class="login" method="post" action="Inscription">

<%-- 
    Document   : loginAdmin
    Created on : 4 août 2021, 10:45:06
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-lg-8 col-sm-6 col-xs-6">
                            <nav class="mainmenu__nav hidden-xs hidden-sm">
                                <ul class="main__menu">
                                    <li class="drop"><a href="#"><h1>Tongasoa/Bienvenue/Welcome...</h1></a></li>
        ...
        <div class="htc__login__register bg__white ptb--130" style="background: rgba(0, 0, 0, 0) url(images/bg/5.jpg) no-repeat scroll center center / cover ;">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <ul class="login__register__menu" role="tablist">
                            <li role="presentation" class="login active"><a href="#login" role="tab" data-toggle="tab">CONNEXION ADMIN</a></li>
                        </ul>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="htc__login__register__wrap">
                            <div id="login" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                                <form class="login" method="post" action="ConnexionAdmin">
                                  ...
                                  <div class="htc__login__btn mt--30">
                                    ...
                                    <div class="row" style="padding-top: 50px;">
                                        <center><a href="index.jsp">Connexion Client</a>
                                    </div>
                                </form>
                ...
                <div class="row" style="text-align: center; ">
                       <%
                        String message =(String)request.getAttribute("messageAdmin") ;
                        if(message!=null){ %>
...
<% }else{ %>
<jsp:forward page="acceuilAdmin.jsp"/>

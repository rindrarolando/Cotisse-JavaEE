                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Liste des réservations non annulés.</h2>
                                            ...
                                            <div class="wishlist-content">
                                                <form action="#">
                                                    ...
                                                    <table>
                                                            <thead>
                                                                <tr>
                                                                    <th class="product-name"><span class="nobr">Client</span></th>
                                                                    <th class="product-name"><span class="nobr">A reservé</span></th>
                                                            ...
                                                            <tbody>
                                                                <% 
                                                                    Class.forName("com.mysql.jdbc.Driver");
                                                                        ...
                                                                        String req ="SELECT * FROM reservation AS r JOIN client AS c ON r.idclient=c.idclient JOIN destination as d ON r.iddestination=d.iddestination WHERE statut=TRUE;";
                                                                    ...
                                                                    try{
                                                                        ...
                                                                        while(res.next()){ %>
                                                                            <tr>
                                                                                <td class="product-name"><%= res.getString("nom") %></a></td>
                                                                                <td class="product-name"><%= res.getString("description") %></td>

...
<%@page import="objects.*"%>
<%@page import="static com.sun.javafx.util.Utils.split"%>
...
<% 
    ...
    Destination dest = service.getDestination(id);
    String[] tab = split(dest.getDescription(),"-");
%>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="htc__login__register__wrap">
                            <div id="login" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                                <form class="login" method="get" action="ModifierVoyage">
                                    
                                    id Voyage:<input type="text" name="id" value="<%=dest.getIdDestination()%>">
                                    Départ:<input type="text" name="depart" value="<%=tab[0]%>">
                                    Destination:<input type="text" name="arrivee" value="<%=tab[1]%>">
